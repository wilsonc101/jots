...
web_root_private = Blueprint('private_webviews', __name__)
...
@web_root_privateroute('/token/refresh')
...
@web_root_privateroute('/admin/groups')
@jwt_required
@protected_view
...
@web_root_privateroute('/admin/users')
@jwt_required
@protected_view
def page_admin_user():
...
@web_root_privateroute('/admin/apps')
@jwt_required
@protected_view
def page_admin_app():
